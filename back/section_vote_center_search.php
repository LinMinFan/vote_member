...
<div class='container'>
    <div class="select">
        <ul>
            ...
            <li><a href="./vote_center.php?search=activ&p=1&o=<?= $order; ?>&t=0&codition=<?= $search; ?>">全部</a></li>
            <?php
            foreach ($types as $kind) {
            ?>
                <li><a href="./vote_center.php?search=activ&p=1&o=<?= $order; ?>&t=<?= $kind['id']; ?>&codition=<?= $search; ?>"><?= $kind['name']; ?></a></li>
            <?php
            }
            ?>
        </ul>
